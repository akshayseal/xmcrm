...
- The admin India map is rendered from a bundled GeoJSON boundary file at `public/assets/maps/india.geojson`, sourced from the open `udit-001/india-maps-data` GeoJSON dataset instead of copying map artwork.
